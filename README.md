...
<table>
  <tr>
    <td>
      <img src="img/[Nested_merging]Cars_SVHN_PF.png" alt="Merge Cars and SVHN" style="width: 200px;">
      <br>
      <div>Merge Cars and SVHN Models</div>
    </td>
    <td>
      <img src="img/[Nested_merging]SUN397_DTD_PF.png" alt="Merge SUN397 and DTD" style="width: 200px;">
      <br>
      <div>Merge SUN397 and DTD Models</div>
    </td>
    <td>
      <img src="img/[Nested_merging]SUN397_DTD_Cars_SVHN_PF.png" alt="Merge SUN397+DTD and Cars+SVHN" style="width: 200px;">
      <br>
